...
class zookeeper (
  ...
  $log4j_template   = $::zookeeper::params::log4j_template,
  $log4j_options    = $::zookeeper::params::log4j_options,
  ...
  $config_options_final = hiera_hash('zookeeper::config_options', $config_options)
  $log4j_options_final = hiera_hash('zookeeper::log4j_options', $log4j_options)
  $service_options_final = hiera_hash('zookeeper::service_options', $service_options)
